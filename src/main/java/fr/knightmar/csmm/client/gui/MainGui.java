...
public class MainGui extends Screen {
    ...
    public MainGui(boolean pFading) {
    ...
    private void createNormalMenuOptions(int pY, int pRowHeight) {
        ...
        Button.OnTooltip button$ontooltip = flag ? Button.NO_TOOLTIP : new Button.OnTooltip() {
            ...
            public void onTooltip(Button p_169458_, PoseStack p_169459_, int p_169460_, int p_169461_) {
                if (!p_169458_.active) {
                    MainGui.this.renderTooltip(p_169459_, MainGui.this.minecraft.font.split(this.text, Math.max(MainGui.this.width / 2 - 43, 170)), p_169460_, p_169461_);
                }
        ...
        (this.addRenderableWidget(new Button(this.width / 2 - 100, pY + pRowHeight * 1, 200, 20, new TranslatableComponent("menu.connexion"), (p_169450_) -> {
            ConnectScreen.startConnecting(this,this.minecraft, ServerAddress.parseString("www.benetnath.fr:9999"),new ServerData("Knightmod server", "www.benetnath.fr:9999", false ));
