...
public class RecipeGenerator extends RecipeProvider {
    ...
    protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        //Crafts items mod
        CookingRecipeBuilder.smelting(Ingredient.of(ModBlocks.PLATINIUM_ORE.get()), ModItems.PLATINIUM_INGOT.get(), 1f, 200)
                .unlockedBy("unlock", InventoryChangeTrigger.Instance.hasItems(ModBlocks.PLATINIUM_ORE.get().asItem()))
                .save(consumer);


        CookingRecipeBuilder.smelting(Ingredient.of(ModBlocks.BRONZE_ORE.get()), ModItems.BRONZE_INGOT.get(), 0.5f, 200)
                .unlockedBy("unlock", InventoryChangeTrigger.Instance.hasItems(ModBlocks.BRONZE_ORE.get().asItem()))
                .save(consumer);
        ...
        ShapedRecipeBuilder.shaped(ModItems.BRONZE_STICK.get(), 4)
                ...
                .group("sticks")
                .unlockedBy("unlock", InventoryChangeTrigger.Instance.hasItems(ModItems.BRONZE_INGOT.get()))
                .save(consumer);
        ...
        ShapedRecipeBuilder.shaped(ModItems.PLATINIUM_SWORD.get(), 1)
                ...
                .define('S', ModItems.BRONZE_STICK.get())
                .unlockedBy("unlock", InventoryChangeTrigger.Instance.hasItems(ModItems.PLATINIUM_INGOT.get()))
                .save(consumer);
        ...
        ShapedRecipeBuilder.shaped(ModItems.BACKPACK.get())
                ...
                .pattern("LCL")
                .pattern("LLL")
                .unlockedBy("unlock", InventoryChangeTrigger.Instance.hasItems(Items.CHEST))
                .save(consumer);
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.TEMP_BLOCK.get())
                ...
                .unlockedBy("unlock", InventoryChangeTrigger.Instance.hasItems(Items.CLOCK))
                .save(consumer);
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.REINFORCED_STONE.get())
                ...
                .unlockedBy("unlock", InventoryChangeTrigger.Instance.hasItems(ModBlocks.PLATINIUM_BLOCK.get()))
                .save(consumer);
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.SOAP_BLOCK.get())
                ...
                .unlockedBy("unlock", InventoryChangeTrigger.Instance.hasItems(Blocks.CLAY))
                .save(consumer);
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.LIGHT_BLOCK.get())
                ...
                .unlockedBy("unlock", InventoryChangeTrigger.Instance.hasItems(Items.DAYLIGHT_DETECTOR))
                .save(consumer);
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.HOME_BLOCK.get())
                ...
                .unlockedBy("unlock", InventoryChangeTrigger.Instance.hasItems(Blocks.BLUE_CARPET))
                .save(consumer);
        ...
        ShapedRecipeBuilder.shaped(Blocks.GRASS_BLOCK, 3)
                ...
                .unlockedBy("unlock", InventoryChangeTrigger.Instance.hasItems(Items.WHEAT_SEEDS, Blocks.DIRT))
                .save(consumer);
