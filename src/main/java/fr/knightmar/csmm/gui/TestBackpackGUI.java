...
public class TestBackpackGUI extends ContainerScreen<BackpackContainer> {
    ...
    public TestBackpackGUI(BackpackContainer container, PlayerInventory playerInventory, ITextComponent textComponent) {
